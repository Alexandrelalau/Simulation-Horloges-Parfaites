...
<p>• Premier ordre (Sagnac) : Décalage dû au fait que les avions
volent autour de la Terre chacun dans un sens différent. Ce
	décalage est positif vers l’ouest et négatif vers l’est.</p>
<p>• Second ordre (Lorentz) : Décalage dû à la vitesse des avions. Ce
...
<form action="action.php" method="post">
 <div class ='ligne'> 
	 ...
	 Vitesse de rotation (en radians par secondes) : <input type="number" name="vitessePlanete" step='any' placeholder='0.00007292'  />
	</div>
 <div class='vehicule'>
	...
	Nombre d'escale du vol 1 : <input type="number" name="nombreEscale1" step='any' placeholder='12'/>
 	...
 	Latitude moyenne de vol 1 (radians) : <input type="number" name="latitude1" step='any' placeholder ='0.575959'/>
 </div>
 <div class='vehicule'>
	...
	Nombre d'escale du vol 2 : <input type="number"name="nombreEscale2" step='any' placeholder='13'/>
 	...
 	Latitude moyenne de vol 2 (radians) : <input type="number" name="latitude2" step='any'placeholder ='0.575959'/>
 </div>
</div>
